...
def plot_basic(stocks, title='Bank Nifty Trading', y_label='Price in RUPEES', x_label='Trading Days'):
    """
    Plots basic pyplot
...
def plot_prediction(actual, prediction, title='Bank Nifty Trading vs Prediction', y_label='Price Rupees', x_label='Trading Days'):
    """
...
def plot_lstm_prediction(actual, prediction, title='Bank Nifty Trading vs Prediction', y_label='Price Rupees', x_label='Trading Days'):
    """
    Plots train, test and prediction
    :param actual: DataFrame containing actual data
    :param prediction: DataFrame containing predicted values
