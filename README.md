...
*Udacity - Advance Machine learning Nano Degree Program : Project-6 (Capstone project)*
...
## Problem Highlights
*The challenge of this project is to accurately predict the future closing value of a given stock across a given period of time in the future.  For this project I have used a Long Short Term Memory networks – usually just called “LSTMs” to predict the closing price of the Bank Nifty using a dataset of past prices*
